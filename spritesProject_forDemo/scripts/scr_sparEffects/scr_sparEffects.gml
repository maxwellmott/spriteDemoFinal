...
//							ID												ALERT TEXT														EFFECT FUNCTION					SFX					ANIMATION
master_grid_add_spar_effect(SPAR_EFFECTS.ARENA_CHANGE_VOLCANO,				textGrid[# 1, SPAR_EFFECTS.ARENA_CHANGE_VOLCANO],				arena_change_volcano,			sfx_arenaChange,	sparFX_arenaChange);			
master_grid_add_spar_effect(SPAR_EFFECTS.ARENA_CHANGE_OCEAN,				textGrid[# 1, SPAR_EFFECTS.ARENA_CHANGE_OCEAN],					arena_change_ocean,				sfx_arenaChange,	sparFX_arenaChange);			
master_grid_add_spar_effect(SPAR_EFFECTS.ARENA_CHANGE_CLOUDS,				textGrid[# 1, SPAR_EFFECTS.ARENA_CHANGE_CLOUDS],				arena_change_clouds,			sfx_arenaChange,	sparFX_arenaChange);			
master_grid_add_spar_effect(SPAR_EFFECTS.ARENA_CHANGE_FOREST,				textGrid[# 1, SPAR_EFFECTS.ARENA_CHANGE_FOREST],				arena_change_forest,			sfx_arenaChange,	sparFX_arenaChange);			
master_grid_add_spar_effect(SPAR_EFFECTS.ARENA_CHANGE_NORMAL,				textGrid[# 1, SPAR_EFFECTS.ARENA_CHANGE_NORMAL],				arena_change_normal,			sfx_arenaChange,	sparFX_arenaChange);			
master_grid_add_spar_effect(SPAR_EFFECTS.SET_MIASMA,						textGrid[# 1, SPAR_EFFECTS.SET_MIASMA],							set_miasma,						sfx_miasma,			sparFX_miasma);					
master_grid_add_spar_effect(SPAR_EFFECTS.SET_HUM,							textGrid[# 1, SPAR_EFFECTS.SET_HUM],							set_hum,						sfx_hum,			sparFX_hum);					
master_grid_add_spar_effect(SPAR_EFFECTS.SET_RUST,							textGrid[# 1, SPAR_EFFECTS.SET_RUST],							set_rust,						sfx_rust,			sparFX_rust);					
master_grid_add_spar_effect(SPAR_EFFECTS.ENERGY_BLAST,						textGrid[# 1, SPAR_EFFECTS.ENERGY_BLAST],						energy_blast,					sfx_energyBlast,	sparFX_energyBlast);			
master_grid_add_spar_effect(SPAR_EFFECTS.BESTOW_MINDSET,					textGrid[# 1, SPAR_EFFECTS.BESTOW_MINDSET],						bestow_mindset,					EMPTY_SFX,			sparFX_receiveBlessing);			
master_grid_add_spar_effect(SPAR_EFFECTS.SHIFT_MINDSET,						textGrid[# 1, SPAR_EFFECTS.SHIFT_MINDSET],						shift_mindset,					EMPTY_SFX,			sparFX_shiftMindset);			
master_grid_add_spar_effect(SPAR_EFFECTS.COPY_MINDSET,						textGrid[# 1, SPAR_EFFECTS.COPY_MINDSET],						copy_mindset,					EMPTY_SFX,			sparFX_copyMindset);			
master_grid_add_spar_effect(SPAR_EFFECTS.RESTORE_MP,						textGrid[# 1, SPAR_EFFECTS.RESTORE_MP],							restore_mp_spar_effect,			EMPTY_SFX,			sparFX_restore);				
master_grid_add_spar_effect(SPAR_EFFECTS.RESTORE_HP,						textGrid[# 1, SPAR_EFFECTS.RESTORE_HP],							restore_hp_spar_effect,			EMPTY_SFX,			sparFX_restore);				
master_grid_add_spar_effect(SPAR_EFFECTS.DEPLETE_MP,						textGrid[# 1, SPAR_EFFECTS.DEPLETE_MP],							deplete_mp_spar_effect,			EMPTY_SFX,			EMPTY_SPRITE);							
master_grid_add_spar_effect(SPAR_EFFECTS.DEPLETE_HP,						textGrid[# 1, SPAR_EFFECTS.DEPLETE_HP],							deplete_hp_spar_effect,			EMPTY_SFX,			EMPTY_SPRITE);							
master_grid_add_spar_effect(SPAR_EFFECTS.DEPLETE_HP_NONLETHAL,				textGrid[# 1, SPAR_EFFECTS.DEPLETE_HP_NONLETHAL],				deplete_hp_nonlethal,			EMPTY_SFX,			EMPTY_SPRITE);							
master_grid_add_spar_effect(SPAR_EFFECTS.SET_BOUND,							textGrid[# 1, SPAR_EFFECTS.SET_BOUND],							set_bound,						sfx_bound,			sparFX_bound);					
master_grid_add_spar_effect(SPAR_EFFECTS.SET_HEXED,							textGrid[# 1, SPAR_EFFECTS.SET_HEXED],							set_hexed,						sfx_hex,			sparFX_hexed);					
master_grid_add_spar_effect(SPAR_EFFECTS.REMOVE_BOUND,						textGrid[# 1, SPAR_EFFECTS.REMOVE_BOUND],						remove_bound,					EMPTY_SFX,			sparFX_clearStatus);			
master_grid_add_spar_effect(SPAR_EFFECTS.REMOVE_HEXED,						textGrid[# 1, SPAR_EFFECTS.REMOVE_HEXED],						remove_hexed,					EMPTY_SFX,			sparFX_clearStatus);			
master_grid_add_spar_effect(SPAR_EFFECTS.CLEAR_MIASMA,						textGrid[# 1, SPAR_EFFECTS.CLEAR_MIASMA],						clear_miasma,					EMPTY_SFX,			sparFX_clearHindrance);			
master_grid_add_spar_effect(SPAR_EFFECTS.CLEAR_HUM,							textGrid[# 1, SPAR_EFFECTS.CLEAR_HUM],							clear_hum,						EMPTY_SFX,			sparFX_clearHindrance);			
master_grid_add_spar_effect(SPAR_EFFECTS.CLEAR_RUST,						textGrid[# 1, SPAR_EFFECTS.CLEAR_RUST],							clear_rust,						EMPTY_SFX,			sparFX_clearHindrance);			
master_grid_add_spar_effect(SPAR_EFFECTS.CLEAR_MINDSET,						textGrid[# 1, SPAR_EFFECTS.CLEAR_MINDSET],						clear_mindset,					EMPTY_SFX,			sparFX_clearStatus);			
master_grid_add_spar_effect(SPAR_EFFECTS.FULLY_RESTORE_HP,					textGrid[# 1, SPAR_EFFECTS.FULLY_RESTORE_HP],					fully_restore_hp,				EMPTY_SFX,			sparFX_restore);				
master_grid_add_spar_effect(SPAR_EFFECTS.FULLY_RESTORE_MP,					textGrid[# 1, SPAR_EFFECTS.FULLY_RESTORE_MP],					fully_restore_mp,				EMPTY_SFX,			sparFX_restore);				
master_grid_add_spar_effect(SPAR_EFFECTS.GRID_ADD_SKYDIVE,					textGrid[# 1, SPAR_EFFECTS.GRID_ADD_SKYDIVE],					grid_add_skydive,				EMPTY_SFX,			sparFX_skydive);				
master_grid_add_spar_effect(SPAR_EFFECTS.GRID_ADD_SNEAK_ATTACK,				textGrid[# 1, SPAR_EFFECTS.GRID_ADD_SNEAK_ATTACK],				grid_add_sneak_attack,			sfx_sneakAttack,	sparFX_sneakAttack);			
master_grid_add_spar_effect(SPAR_EFFECTS.GRID_ADD_TIMED_BLAST,				textGrid[# 1, SPAR_EFFECTS.GRID_ADD_TIMED_BLAST],				grid_add_timed_blast,			EMPTY_SFX,			sparFX_timedBlast);				
master_grid_add_spar_effect(SPAR_EFFECTS.CLEAR_TEAM_HINDRANCES,				textGrid[# 1, SPAR_EFFECTS.CLEAR_TEAM_HINDRANCES],				clear_team_hindrances,			EMPTY_SFX,			sparFX_clearTeamHindrance);		
master_grid_add_spar_effect(SPAR_EFFECTS.CLEAR_ALL_HINDRANCES,				textGrid[# 1, SPAR_EFFECTS.CLEAR_ALL_HINDRANCES],				clear_all_hindrances,			EMPTY_SFX,			sparFX_clearTeamHindrance);		
master_grid_add_spar_effect(SPAR_EFFECTS.BLAST_TIMER_GO_OFF,				textGrid[# 1, SPAR_EFFECTS.BLAST_TIMER_GO_OFF],					blast_timer_go_off,				EMPTY_SFX,			sparFX_energyBlast);			
master_grid_add_spar_effect(SPAR_EFFECTS.BLAST_TIMERS_DECREMENT_COUNT,		textGrid[# 1, SPAR_EFFECTS.BLAST_TIMERS_DECREMENT_COUNT],		blast_timers_decrement_count,	EMPTY_SFX,			sparFX_timedBlast);				
master_grid_add_spar_effect(SPAR_EFFECTS.APPLY_MIASMA,						textGrid[# 1, SPAR_EFFECTS.APPLY_MIASMA],						apply_miasma,					sfx_miasma,			sparFX_miasma);					
master_grid_add_spar_effect(SPAR_EFFECTS.APPLY_HUM,							textGrid[# 1, SPAR_EFFECTS.APPLY_HUM],							apply_hum,						sfx_hum,			sparFX_hum);					
master_grid_add_spar_effect(SPAR_EFFECTS.APPLY_RUST,						textGrid[# 1, SPAR_EFFECTS.APPLY_RUST],							apply_rust,						sfx_rust,			sparFX_rust);					
master_grid_add_spar_effect(SPAR_EFFECTS.FORCE_SWAP,						textGrid[# 1, SPAR_EFFECTS.FORCE_SWAP],							force_swap,						EMPTY_SFX,			sparFX_forceSwap);				
master_grid_add_spar_effect(SPAR_EFFECTS.FORCE_SWAP_TEAM,					textGrid[# 1, SPAR_EFFECTS.FORCE_SWAP_TEAM],					force_swap_team,				EMPTY_SFX,			sparFX_forceSwap);				
master_grid_add_spar_effect(SPAR_EFFECTS.FORCE_SWAP_GLOBAL,					textGrid[# 1, SPAR_EFFECTS.FORCE_SWAP_GLOBAL],					force_swap_global,				EMPTY_SFX,			sparFX_forceSwap);				
master_grid_add_spar_effect(SPAR_EFFECTS.SET_MIASMA_GLOBAL,					textGrid[# 1, SPAR_EFFECTS.SET_MIASMA_GLOBAL],					set_miasma_global,				sfx_miasma,			sparFX_miasma);					
master_grid_add_spar_effect(SPAR_EFFECTS.SET_HUM_GLOBAL,					textGrid[# 1, SPAR_EFFECTS.SET_HUM_GLOBAL],						set_hum_global,					sfx_hum,			sparFX_hum);					
master_grid_add_spar_effect(SPAR_EFFECTS.SET_RUST_GLOBAL,					textGrid[# 1, SPAR_EFFECTS.SET_RUST_GLOBAL],					set_rust_global,				sfx_rust,			sparFX_rust);					
master_grid_add_spar_effect(SPAR_EFFECTS.CLEAR_MIASMA_GLOBAL,				textGrid[# 1, SPAR_EFFECTS.CLEAR_MIASMA_GLOBAL],				clear_miasma_global,			EMPTY_SFX,			sparFX_clearHindrance);			
master_grid_add_spar_effect(SPAR_EFFECTS.CLEAR_HUM_GLOBAL,					textGrid[# 1, SPAR_EFFECTS.CLEAR_HUM_GLOBAL],					clear_hum_global,				EMPTY_SFX,			sparFX_clearHindrance);			
master_grid_add_spar_effect(SPAR_EFFECTS.CLEAR_RUST_GLOBAL,					textGrid[# 1, SPAR_EFFECTS.CLEAR_RUST_GLOBAL],					clear_rust_global,				EMPTY_SFX,			sparFX_clearHindrance);			
master_grid_add_spar_effect(SPAR_EFFECTS.CLEAR_MINDSET_NEARBY_ALLIES,		textGrid[# 1, SPAR_EFFECTS.CLEAR_MINDSET_NEARBY_ALLIES],		clear_mindset_nearby_allies,	EMPTY_SFX,			sparFX_clearStatus);			
master_grid_add_spar_effect(SPAR_EFFECTS.CLEAR_MINDSET_NEARBY_ENEMIES,		textGrid[# 1, SPAR_EFFECTS.CLEAR_MINDSET_NEARBY_ENEMIES],		clear_mindset_nearby_enemies,	EMPTY_SFX,			sparFX_clearStatus);			
master_grid_add_spar_effect(SPAR_EFFECTS.CLEAR_MINDSET_NEARBY_SPRITES,		textGrid[# 1, SPAR_EFFECTS.CLEAR_MINDSET_NEARBY_SPRITES],		clear_mindset_nearby_sprites,	EMPTY_SFX,			sparFX_clearStatus);			
master_grid_add_spar_effect(SPAR_EFFECTS.CLEAR_MINDSET_TEAM,				textGrid[# 1, SPAR_EFFECTS.CLEAR_MINDSET_TEAM],					clear_mindset_team,				EMPTY_SFX,			sparFX_clearStatus);			
master_grid_add_spar_effect(SPAR_EFFECTS.CLEAR_MINDSET_GLOBAL,				textGrid[# 1, SPAR_EFFECTS.CLEAR_MINDSET_GLOBAL],				clear_mindset_global,			EMPTY_SFX,			sparFX_clearStatus);			
master_grid_add_spar_effect(SPAR_EFFECTS.BESTOW_MINDSET_NEARBY_ALLIES,		textGrid[# 1, SPAR_EFFECTS.BESTOW_MINDSET_NEARBY_ALLIES],		bestow_mindset_nearby_allies,	EMPTY_SFX,			sparFX_receiveBlessing);			
master_grid_add_spar_effect(SPAR_EFFECTS.BESTOW_MINDSET_NEARBY_ENEMIES,		textGrid[# 1, SPAR_EFFECTS.BESTOW_MINDSET_NEARBY_ENEMIES],		bestow_mindset_nearby_enemies,	EMPTY_SFX,			sparFX_receiveBlessing);			
master_grid_add_spar_effect(SPAR_EFFECTS.BESTOW_MINDSET_NEARBY_SPRITES,		textGrid[# 1, SPAR_EFFECTS.BESTOW_MINDSET_NEARBY_SPRITES],		bestow_mindset_nearby_sprites,	EMPTY_SFX,			sparFX_receiveBlessing);			
master_grid_add_spar_effect(SPAR_EFFECTS.BESTOW_MINDSET_TEAM,				textGrid[# 1, SPAR_EFFECTS.BESTOW_MINDSET_TEAM],				bestow_mindset_team,			EMPTY_SFX,			sparFX_receiveBlessing);			
master_grid_add_spar_effect(SPAR_EFFECTS.BESTOW_MINDSET_GLOBAL,				textGrid[# 1, SPAR_EFFECTS.BESTOW_MINDSET_GLOBAL],				bestow_mindset_global,			EMPTY_SFX,			sparFX_receiveBlessing);			
master_grid_add_spar_effect(SPAR_EFFECTS.SHIFT_MINDSET_NEARBY_ALLIES,		textGrid[# 1, SPAR_EFFECTS.SHIFT_MINDSET_NEARBY_ALLIES],		shift_mindset_nearby_allies,	EMPTY_SFX,			sparFX_shiftMindset);			
master_grid_add_spar_effect(SPAR_EFFECTS.SHIFT_MINDSET_NEARBY_ENEMIES,		textGrid[# 1, SPAR_EFFECTS.SHIFT_MINDSET_NEARBY_ENEMIES],		shift_mindset_nearby_enemies,	EMPTY_SFX,			sparFX_shiftMindset);			
master_grid_add_spar_effect(SPAR_EFFECTS.SHIFT_MINDSET_NEARBY_SPRITES,		textGrid[# 1, SPAR_EFFECTS.SHIFT_MINDSET_NEARBY_SPRITES],		shift_mindset_nearby_sprites,	EMPTY_SFX,			sparFX_shiftMindset);			
master_grid_add_spar_effect(SPAR_EFFECTS.SHIFT_MINDSET_TEAM,				textGrid[# 1, SPAR_EFFECTS.SHIFT_MINDSET_TEAM],					shift_mindset_team,				EMPTY_SFX,			sparFX_shiftMindset);			
master_grid_add_spar_effect(SPAR_EFFECTS.SHIFT_MINDSET_GLOBAL,				textGrid[# 1, SPAR_EFFECTS.SHIFT_MINDSET_GLOBAL],				shift_mindset_global,			EMPTY_SFX,			sparFX_shiftMindset);			
master_grid_add_spar_effect(SPAR_EFFECTS.SHIFT_CURSE,						textGrid[# 1, SPAR_EFFECTS.SHIFT_CURSE],						shift_curse,					EMPTY_SFX,			sparFX_shiftMindset);			
master_grid_add_spar_effect(SPAR_EFFECTS.SHIFT_BLESSING,					textGrid[# 1, SPAR_EFFECTS.SHIFT_BLESSING],						shift_blessing,					EMPTY_SFX,			sparFX_shiftMindset);			
master_grid_add_spar_effect(SPAR_EFFECTS.SHIFT_CURSE_NEARBY_ALLIES,			textGrid[# 1, SPAR_EFFECTS.SHIFT_CURSE_NEARBY_ALLIES],			shift_curse_nearby_allies,		EMPTY_SFX,			sparFX_shiftMindset);			
master_grid_add_spar_effect(SPAR_EFFECTS.SHIFT_CURSE_NEARBY_ENEMIES,		textGrid[# 1, SPAR_EFFECTS.SHIFT_CURSE_NEARBY_ENEMIES],			shift_curse_nearby_enemies,		EMPTY_SFX,			sparFX_shiftMindset);			
master_grid_add_spar_effect(SPAR_EFFECTS.SHIFT_CURSE_NEARBY_SPRITES,		textGrid[# 1, SPAR_EFFECTS.SHIFT_CURSE_NEARBY_SPRITES],			shift_curse_nearby_sprites,		EMPTY_SFX,			sparFX_shiftMindset);			
master_grid_add_spar_effect(SPAR_EFFECTS.SHIFT_CURSE_TEAM,					textGrid[# 1, SPAR_EFFECTS.SHIFT_CURSE_TEAM],					shift_curse_team,				EMPTY_SFX,			sparFX_shiftMindset);			
master_grid_add_spar_effect(SPAR_EFFECTS.SHIFT_CURSE_GLOBAL,				textGrid[# 1, SPAR_EFFECTS.SHIFT_CURSE_GLOBAL],					shift_curse_global,				EMPTY_SFX,			sparFX_shiftMindset);			
master_grid_add_spar_effect(SPAR_EFFECTS.SHIFT_BLESSING_NEARBY_ALLIES,		textGrid[# 1, SPAR_EFFECTS.SHIFT_BLESSING_NEARBY_ALLIES],		shift_blessing_nearby_allies,	EMPTY_SFX,			sparFX_shiftMindset);			
master_grid_add_spar_effect(SPAR_EFFECTS.SHIFT_BLESSING_NEARBY_ENEMIES,		textGrid[# 1, SPAR_EFFECTS.SHIFT_BLESSING_NEARBY_ENEMIES],		shift_blessing_nearby_enemies,	EMPTY_SFX,			sparFX_shiftMindset);			
master_grid_add_spar_effect(SPAR_EFFECTS.SHIFT_BLESSING_NEARBY_SPRITES,		textGrid[# 1, SPAR_EFFECTS.SHIFT_BLESSING_NEARBY_SPRITES],		shift_blessing_nearby_sprites,	EMPTY_SFX,			sparFX_shiftMindset);			
master_grid_add_spar_effect(SPAR_EFFECTS.SHIFT_BLESSING_TEAM,				textGrid[# 1, SPAR_EFFECTS.SHIFT_BLESSING_TEAM],				shift_blessing_team,			EMPTY_SFX,			sparFX_shiftMindset);			
master_grid_add_spar_effect(SPAR_EFFECTS.SHIFT_BLESSING_GLOBAL,				textGrid[# 1, SPAR_EFFECTS.SHIFT_BLESSING_GLOBAL],				shift_blessing_global,			EMPTY_SFX,			sparFX_shiftMindset);			
master_grid_add_spar_effect(SPAR_EFFECTS.SET_HEXED_NEARBY_ALLIES,			textGrid[# 1, SPAR_EFFECTS.SET_HEXED_NEARBY_ALLIES],			set_hexed_nearby_allies,		sfx_hex,			sparFX_hexed);					
master_grid_add_spar_effect(SPAR_EFFECTS.SET_HEXED_NEARBY_ENEMIES,			textGrid[# 1, SPAR_EFFECTS.SET_HEXED_NEARBY_ENEMIES],			set_hexed_nearby_enemies,		sfx_hex,			sparFX_hexed);					
master_grid_add_spar_effect(SPAR_EFFECTS.SET_HEXED_NEARBY_SPRITES,			textGrid[# 1, SPAR_EFFECTS.SET_HEXED_NEARBY_SPRITES],			set_hexed_nearby_sprites,		sfx_hex,			sparFX_hexed);					
master_grid_add_spar_effect(SPAR_EFFECTS.SET_HEXED_TEAM,					textGrid[# 1, SPAR_EFFECTS.SET_HEXED_TEAM],						set_hexed_team,					sfx_hex,			sparFX_hexed);					
master_grid_add_spar_effect(SPAR_EFFECTS.SET_HEXED_GLOBAL,					textGrid[# 1, SPAR_EFFECTS.SET_HEXED_GLOBAL],					set_hexed_global,				sfx_hex,			sparFX_hexed);					
master_grid_add_spar_effect(SPAR_EFFECTS.SET_BOUND_NEARBY_ALLIES,			textGrid[# 1, SPAR_EFFECTS.SET_BOUND_NEARBY_ALLIES],			set_bound_nearby_allies,		sfx_bound,			sparFX_bound);					
master_grid_add_spar_effect(SPAR_EFFECTS.SET_BOUND_NEARBY_ENEMIES,			textGrid[# 1, SPAR_EFFECTS.SET_BOUND_NEARBY_ENEMIES],			set_bound_nearby_enemies,		sfx_bound,			sparFX_bound);					
master_grid_add_spar_effect(SPAR_EFFECTS.SET_BOUND_NEARBY_SPRITES,			textGrid[# 1, SPAR_EFFECTS.SET_BOUND_NEARBY_SPRITES],			set_bound_nearby_sprites,		sfx_bound,			sparFX_bound);					
master_grid_add_spar_effect(SPAR_EFFECTS.SET_BOUND_TEAM,					textGrid[# 1, SPAR_EFFECTS.SET_BOUND_TEAM],						set_bound_team,					sfx_bound,			sparFX_bound);					
master_grid_add_spar_effect(SPAR_EFFECTS.SET_BOUND_GLOBAL,					textGrid[# 1, SPAR_EFFECTS.SET_BOUND_GLOBAL],					set_bound_global,				sfx_bound,			sparFX_bound);					
master_grid_add_spar_effect(SPAR_EFFECTS.APPLY_HEXED,						textGrid[# 1, SPAR_EFFECTS.APPLY_HEXED],						apply_hexed,					sfx_hex,			sparFX_hexed);					
master_grid_add_spar_effect(SPAR_EFFECTS.APPLY_BOUND,						textGrid[# 1, SPAR_EFFECTS.APPLY_BOUND],						apply_bound,					sfx_bound,			sparFX_bound);					
master_grid_add_spar_effect(SPAR_EFFECTS.ENERGY_BLAST_GLOBAL,				textGrid[# 1, SPAR_EFFECTS.ENERGY_BLAST_GLOBAL],				energy_blast_global,			sfx_energyBlast,	sparFX_energyBlast);			
master_grid_add_spar_effect(SPAR_EFFECTS.INCREASE_DAMAGE,					textGrid[# 1, SPAR_EFFECTS.INCREASE_DAMAGE],					increase_damage,				EMPTY_SFX,			sparFX_increaseDamage);			
master_grid_add_spar_effect(SPAR_EFFECTS.DECREASE_DAMAGE,					textGrid[# 1, SPAR_EFFECTS.DECREASE_DAMAGE],					decrease_damage,				EMPTY_SFX,			sparFX_decreaseDamage);			
master_grid_add_spar_effect(SPAR_EFFECTS.INCREASE_DAMAGE_NATURAL,			textGrid[# 1, SPAR_EFFECTS.INCREASE_DAMAGE_NATURAL],			increase_damage_natural,		EMPTY_SFX,			sparFX_increaseDamage);			
master_grid_add_spar_effect(SPAR_EFFECTS.DECREASE_DAMAGE_NATURAL,			textGrid[# 1, SPAR_EFFECTS.DECREASE_DAMAGE_NATURAL],			decrease_damage_natural,		EMPTY_SFX,			sparFX_decreaseDamage);			
master_grid_add_spar_effect(SPAR_EFFECTS.INCREASE_DAMAGE_MECHANICAL,		textGrid[# 1, SPAR_EFFECTS.INCREASE_DAMAGE_MECHANICAL],			increase_damage_mechanical,		EMPTY_SFX,			sparFX_increaseDamage);			
master_grid_add_spar_effect(SPAR_EFFECTS.DECREASE_DAMAGE_MECHANICAL,		textGrid[# 1, SPAR_EFFECTS.DECREASE_DAMAGE_MECHANICAL],			decrease_damage_mechanical,		EMPTY_SFX,			sparFX_decreaseDamage);			
master_grid_add_spar_effect(SPAR_EFFECTS.INCREASE_DAMAGE_ASTRAL,			textGrid[# 1, SPAR_EFFECTS.INCREASE_DAMAGE_ASTRAL],				increase_damage_astral,			EMPTY_SFX,			sparFX_increaseDamage);			
master_grid_add_spar_effect(SPAR_EFFECTS.DECREASE_DAMAGE_ASTRAL,			textGrid[# 1, SPAR_EFFECTS.DECREASE_DAMAGE_ASTRAL],				decrease_damage_astral,			EMPTY_SFX,			sparFX_decreaseDamage);			
master_grid_add_spar_effect(SPAR_EFFECTS.VOLCANO_WATER_DECREASE_DAMAGE,		textGrid[# 1, SPAR_EFFECTS.VOLCANO_WATER_DECREASE_DAMAGE],		volcano_water_decrease_damage,	EMPTY_SFX,			sparFX_decreaseDamage);			
master_grid_add_spar_effect(SPAR_EFFECTS.VOLCANO_FIRE_INCREASE_DAMAGE,		textGrid[# 1, SPAR_EFFECTS.VOLCANO_FIRE_INCREASE_DAMAGE],		volcano_fire_increase_damage,	EMPTY_SFX,			sparFX_increaseDamage);			
master_grid_add_spar_effect(SPAR_EFFECTS.OCEAN_FIRE_DECREASE_DAMAGE,		textGrid[# 1, SPAR_EFFECTS.OCEAN_FIRE_DECREASE_DAMAGE],			ocean_fire_decrease_damage,		EMPTY_SFX,			sparFX_decreaseDamage);			
master_grid_add_spar_effect(SPAR_EFFECTS.OCEAN_STORM_INCREASE_DAMAGE,		textGrid[# 1, SPAR_EFFECTS.OCEAN_STORM_INCREASE_DAMAGE],		ocean_storm_increase_damage,	EMPTY_SFX,			sparFX_increaseDamage);			
master_grid_add_spar_effect(SPAR_EFFECTS.OCEAN_WATER_INCREASE_DAMAGE,		textGrid[# 1, SPAR_EFFECTS.OCEAN_WATER_INCREASE_DAMAGE],		ocean_water_increase_damage,	EMPTY_SFX,			sparFX_increaseDamage);			
master_grid_add_spar_effect(SPAR_EFFECTS.STRATOS_EARTH_DECREASE_DAMAGE,		textGrid[# 1, SPAR_EFFECTS.STRATOS_EARTH_DECREASE_DAMAGE],		stratos_earth_decrease_damage,	EMPTY_SFX,			sparFX_decreaseDamage);			
master_grid_add_spar_effect(SPAR_EFFECTS.STRATOS_STORM_INCREASE_DAMAGE,		textGrid[# 1, SPAR_EFFECTS.STRATOS_STORM_INCREASE_DAMAGE],		stratos_storm_increase_damage,	EMPTY_SFX,			sparFX_increaseDamage);			
master_grid_add_spar_effect(SPAR_EFFECTS.FOREST_FIRE_INCREASE_DAMAGE,		textGrid[# 1, SPAR_EFFECTS.FOREST_FIRE_INCREASE_DAMAGE],		forest_fire_increase_damage,	EMPTY_SFX,			sparFX_increaseDamage);			
master_grid_add_spar_effect(SPAR_EFFECTS.FOREST_EARTH_INCREASE_DAMAGE,		textGrid[# 1, SPAR_EFFECTS.FOREST_EARTH_INCREASE_DAMAGE],		forest_earth_increase_damage,	EMPTY_SFX,			sparFX_increaseDamage);			
master_grid_add_spar_effect(SPAR_EFFECTS.DESTROY_ARENA,						textGrid[# 1, SPAR_EFFECTS.DESTROY_ARENA],						destroy_arena,					EMPTY_SFX,			sparFX_destroyArena);			
master_grid_add_spar_effect(SPAR_EFFECTS.DRAIN_HEALTH,						textGrid[# 1, SPAR_EFFECTS.DRAIN_HEALTH],						drain_health,					EMPTY_SFX,			sparFX_restore);				
master_grid_add_spar_effect(SPAR_EFFECTS.DRAIN_MAGIC,						textGrid[# 1, SPAR_EFFECTS.DRAIN_MAGIC],						drain_magic,					EMPTY_SFX,			sparFX_restore);				
master_grid_add_spar_effect(SPAR_EFFECTS.REPLACE_TARGET,					textGrid[# 1, SPAR_EFFECTS.REPLACE_TARGET],						replace_target,					EMPTY_SFX,			sparFX_replaceTarget);			
master_grid_add_spar_effect(SPAR_EFFECTS.BALL_LIGHTNING_SET_ACTIVE,			textGrid[# 1, SPAR_EFFECTS.BALL_LIGHTNING_SET_ACTIVE],			ball_lightning_set_active,		EMPTY_SFX,			sparFX_ballLightning);			
master_grid_add_spar_effect(SPAR_EFFECTS.BALL_LIGHTNING_ABSORB_SPELL,		textGrid[# 1, SPAR_EFFECTS.BALL_LIGHTNING_ABSORB_SPELL],		ball_lightning_absorb_spell,	EMPTY_SFX,			sparFX_ballLightning);			
master_grid_add_spar_effect(SPAR_EFFECTS.BALL_LIGHTNING_APPLY_DAMAGE,		textGrid[# 1, SPAR_EFFECTS.BALL_LIGHTNING_APPLY_DAMAGE],		ball_lightning_apply_damage,	EMPTY_SFX,			sparFX_energyBlast);			
master_grid_add_spar_effect(SPAR_EFFECTS.BLACK_HOLE_SET_ACTIVE,				textGrid[# 1, SPAR_EFFECTS.BLACK_HOLE_SET_ACTIVE],				black_hole_set_active,			EMPTY_SFX,			sparFX_blackHole);				
master_grid_add_spar_effect(SPAR_EFFECTS.BLACK_HOLE_ABSORB_SPELL,			textGrid[# 1, SPAR_EFFECTS.BLACK_HOLE_ABSORB_SPELL],			black_hole_absorb_spell,		EMPTY_SFX,			sparFX_blackHole);				
master_grid_add_spar_effect(SPAR_EFFECTS.BLACK_HOLE_APPLY_DAMAGE,			textGrid[# 1, SPAR_EFFECTS.BLACK_HOLE_APPLY_DAMAGE],			black_hole_apply_damage,		EMPTY_SFX,			sparFX_energyBlast);			
master_grid_add_spar_effect(SPAR_EFFECTS.APPLY_SELF_DAMAGE,					textGrid[# 1, SPAR_EFFECTS.APPLY_SELF_DAMAGE],					apply_self_damage,				EMPTY_SFX,			EMPTY_SPRITE);							
master_grid_add_spar_effect(SPAR_EFFECTS.SET_BERSERK,						textGrid[# 1, SPAR_EFFECTS.SET_BERSERK],						set_berserk,					EMPTY_SFX,			sparFX_berserk);				
master_grid_add_spar_effect(SPAR_EFFECTS.SET_BERSERK_NEARBY_ALLIES,			textGrid[# 1, SPAR_EFFECTS.SET_BERSERK_NEARBY_ALLIES],			set_berserk_nearby_allies,		EMPTY_SFX,			sparFX_berserk);				
master_grid_add_spar_effect(SPAR_EFFECTS.SET_BERSERK_NEARBY_ENEMIES,		textGrid[# 1, SPAR_EFFECTS.SET_BERSERK_NEARBY_ENEMIES],			set_berserk_nearby_enemies,		EMPTY_SFX,			sparFX_berserk);				
master_grid_add_spar_effect(SPAR_EFFECTS.SET_BERSERK_NEARBY_SPRITES,		textGrid[# 1, SPAR_EFFECTS.SET_BERSERK_NEARBY_SPRITES],			set_berserk_nearby_sprites,		EMPTY_SFX,			sparFX_berserk);				
master_grid_add_spar_effect(SPAR_EFFECTS.SET_BERSERK_TEAM,					textGrid[# 1, SPAR_EFFECTS.SET_BERSERK_TEAM],					set_berserk_team,				EMPTY_SFX,			sparFX_berserk);				
master_grid_add_spar_effect(SPAR_EFFECTS.SET_BERSERK_GLOBAL,				textGrid[# 1, SPAR_EFFECTS.SET_BERSERK_GLOBAL],					set_berserk_global,				EMPTY_SFX,			sparFX_berserk);				
master_grid_add_spar_effect(SPAR_EFFECTS.SET_INVULNERABLE,					textGrid[# 1, SPAR_EFFECTS.SET_INVULNERABLE],					set_invulnerable,				sfx_invulnerable,	sparFX_invulnerable);			
master_grid_add_spar_effect(SPAR_EFFECTS.SET_INVULNERABLE_NEARBY_ALLIES,	textGrid[# 1, SPAR_EFFECTS.SET_INVULNERABLE_NEARBY_ALLIES],		set_invulnerable_nearby_allies,	sfx_invulnerable,	sparFX_invulnerable);			
master_grid_add_spar_effect(SPAR_EFFECTS.SET_INVULNERABLE_NEARBY_ENEMIES,	textGrid[# 1, SPAR_EFFECTS.SET_INVULNERABLE_NEARBY_ENEMIES],	set_invulnerable_nearby_enemies,sfx_invulnerable,	sparFX_invulnerable);			
master_grid_add_spar_effect(SPAR_EFFECTS.SET_INVULNERABLE_NEARBY_SPRITES,	textGrid[# 1, SPAR_EFFECTS.SET_INVULNERABLE_NEARBY_SPRITES],	set_invulnerable_nearby_sprites,sfx_invulnerable,	sparFX_invulnerable);			
master_grid_add_spar_effect(SPAR_EFFECTS.SET_INVULNERABLE_TEAM,				textGrid[# 1, SPAR_EFFECTS.SET_INVULNERABLE_TEAM],				set_invulnerable_team,			sfx_invulnerable,	sparFX_invulnerable);			
master_grid_add_spar_effect(SPAR_EFFECTS.SET_INVULNERABLE_GLOBAL,			textGrid[# 1, SPAR_EFFECTS.SET_INVULNERABLE_GLOBAL],			set_invulnerable_global,		sfx_invulnerable,	sparFX_invulnerable);			
master_grid_add_spar_effect(SPAR_EFFECTS.SET_PARRYING,						textGrid[# 1, SPAR_EFFECTS.SET_PARRYING],						set_parrying,					sfx_sneakAttack,	sparFX_parry);					
master_grid_add_spar_effect(SPAR_EFFECTS.APPLY_PARRY,						textGrid[# 1, SPAR_EFFECTS.APPLY_PARRY],						apply_parry,					EMPTY_SFX,			spr_spellFX_basicAttack);				
master_grid_add_spar_effect(SPAR_EFFECTS.IGNORE_PARRY,						textGrid[# 1, SPAR_EFFECTS.IGNORE_PARRY],						ignore_parry,					EMPTY_SFX,			sparFX_ignoreParry);			
master_grid_add_spar_effect(SPAR_EFFECTS.SET_DIVIDING,						textGrid[# 1, SPAR_EFFECTS.SET_DIVIDING],						set_dividing,					EMPTY_SFX,			sparFX_divide);					
master_grid_add_spar_effect(SPAR_EFFECTS.SET_MULTIPLYING,					textGrid[# 1, SPAR_EFFECTS.SET_MULTIPLYING],					set_multiplying,				EMPTY_SFX,			sparFX_multiply);				
master_grid_add_spar_effect(SPAR_EFFECTS.DIVIDE_HEALING,					textGrid[# 1, SPAR_EFFECTS.DIVIDE_HEALING],						divide_healing,					EMPTY_SFX,			sparFX_divide);					
master_grid_add_spar_effect(SPAR_EFFECTS.DIVIDE_DAMAGE,						textGrid[# 1, SPAR_EFFECTS.DIVIDE_DAMAGE],						divide_damage,					EMPTY_SFX,			sparFX_divide);					
master_grid_add_spar_effect(SPAR_EFFECTS.MULTIPLY_HEALING,					textGrid[# 1, SPAR_EFFECTS.MULTIPLY_HEALING],					multiply_healing,				EMPTY_SFX,			sparFX_multiply);				
master_grid_add_spar_effect(SPAR_EFFECTS.MULTIPLY_DAMAGE,					textGrid[# 1, SPAR_EFFECTS.MULTIPLY_DAMAGE],					multiply_damage,				EMPTY_SFX,			sparFX_multiply);				
master_grid_add_spar_effect(SPAR_EFFECTS.SET_DEFLECTIVE,					textGrid[# 1, SPAR_EFFECTS.SET_DEFLECTIVE],						set_deflective,					EMPTY_SFX,			sparFX_deflect);				
master_grid_add_spar_effect(SPAR_EFFECTS.DEFLECT_SPELL,						textGrid[# 1, SPAR_EFFECTS.DEFLECT_SPELL],						deflect_spell,					EMPTY_SFX,			sparFX_deflect);				
master_grid_add_spar_effect(SPAR_EFFECTS.FORCE_TURN_END,					textGrid[# 1, SPAR_EFFECTS.FORCE_TURN_END],						force_turn_end,					EMPTY_SFX,			sparFX_time);					
master_grid_add_spar_effect(SPAR_EFFECTS.REPEAT_LAST_TURN,					textGrid[# 1, SPAR_EFFECTS.REPEAT_LAST_TURN],					repeat_last_turn,				EMPTY_SFX,			sparFX_time);					
master_grid_add_spar_effect(SPAR_EFFECTS.PSYCHIC_ATTACK,					textGrid[# 1, SPAR_EFFECTS.PSYCHIC_ATTACK],						psychic_attack,					EMPTY_SFX,			EMPTY_SPRITE);							
master_grid_add_spar_effect(SPAR_EFFECTS.CHANGE_ALIGNMENT,					textGrid[# 1, SPAR_EFFECTS.CHANGE_ALIGNMENT],					change_alignment,				EMPTY_SFX,			sparFX_alignment);				
master_grid_add_spar_effect(SPAR_EFFECTS.CHANGE_SIZE,						textGrid[# 1, SPAR_EFFECTS.CHANGE_SIZE],						change_size,					EMPTY_SFX,			sparFX_size);					
master_grid_add_spar_effect(SPAR_EFFECTS.ENERGY_BLAST_SELF,					textGrid[# 1, SPAR_EFFECTS.ENERGY_BLAST_SELF],					energy_blast_self,				EMPTY_SFX,			sparFX_energyBlast);			
master_grid_add_spar_effect(SPAR_EFFECTS.FORCE_BEST_LUCK,					textGrid[# 1, SPAR_EFFECTS.FORCE_BEST_LUCK],					force_best_luck,				EMPTY_SFX,			sparFX_luck);					
master_grid_add_spar_effect(SPAR_EFFECTS.FORCE_WORST_LUCK,					textGrid[# 1, SPAR_EFFECTS.FORCE_WORST_LUCK],					force_worst_luck,				EMPTY_SFX,			sparFX_luck);					
master_grid_add_spar_effect(SPAR_EFFECTS.FORCE_BEST_LUCK_TEAM,				textGrid[# 1, SPAR_EFFECTS.FORCE_BEST_LUCK_TEAM],				force_best_luck_team,			EMPTY_SFX,			sparFX_luck);					
master_grid_add_spar_effect(SPAR_EFFECTS.FORCE_WORST_LUCK_TEAM,				textGrid[# 1, SPAR_EFFECTS.FORCE_WORST_LUCK_TEAM],				force_worst_luck_team,			EMPTY_SFX,			sparFX_luck);					
master_grid_add_spar_effect(SPAR_EFFECTS.FORCE_BEST_LUCK_GLOBAL,			textGrid[# 1, SPAR_EFFECTS.FORCE_BEST_LUCK_GLOBAL],				force_best_luck_global,			EMPTY_SFX,			sparFX_luck);					
master_grid_add_spar_effect(SPAR_EFFECTS.FORCE_WORST_LUCK_GLOBAL,			textGrid[# 1, SPAR_EFFECTS.FORCE_WORST_LUCK_GLOBAL],			force_worst_luck_global,		EMPTY_SFX,			sparFX_luck);					
master_grid_add_spar_effect(SPAR_EFFECTS.SET_HAIL_SPHERA,					textGrid[# 1, SPAR_EFFECTS.SET_HAIL_SPHERA],					set_hail_sphera,				EMPTY_SFX,			EMPTY_SPRITE);							
master_grid_add_spar_effect(SPAR_EFFECTS.HAIL_SPHERA_SET_INVULNERABLE,		textGrid[# 1, SPAR_EFFECTS.HAIL_SPHERA_SET_INVULNERABLE],		hail_sphera_set_invulnerable,	EMPTY_SFX,			sparFX_invulnerable);			
master_grid_add_spar_effect(SPAR_EFFECTS.BERSERK_INCREASE_DAMAGE,			textGrid[# 1, SPAR_EFFECTS.BERSERK_INCREASE_DAMAGE],			berserk_increase_damage,		EMPTY_SFX,			sparFX_berserk);				
master_grid_add_spar_effect(SPAR_EFFECTS.APPLY_BERSERK,						textGrid[# 1, SPAR_EFFECTS.APPLY_BERSERK],						apply_berserk,					EMPTY_SFX,			sparFX_berserk);				
master_grid_add_spar_effect(SPAR_EFFECTS.APPLY_INVULNERABLE,				textGrid[# 1, SPAR_EFFECTS.APPLY_INVULNERABLE],					apply_invulnerable,				sfx_invulnerable,	sparFX_invulnerable);			
master_grid_add_spar_effect(SPAR_EFFECTS.END_BERSERK,						textGrid[# 1, SPAR_EFFECTS.END_BERSERK],						end_berserk,					EMPTY_SFX,			sparFX_clearStatus);			
master_grid_add_spar_effect(SPAR_EFFECTS.END_BERSERK_NEARBY_ALLIES,			textGrid[# 1, SPAR_EFFECTS.END_BERSERK_NEARBY_ALLIES],			end_berserk_nearby_allies,		EMPTY_SFX,			sparFX_clearStatus);			
master_grid_add_spar_effect(SPAR_EFFECTS.END_BERSERK_NEARBY_ENEMIES,		textGrid[# 1, SPAR_EFFECTS.END_BERSERK_NEARBY_ENEMIES],			end_berserk_nearby_allies,		EMPTY_SFX,			sparFX_clearStatus);			
master_grid_add_spar_effect(SPAR_EFFECTS.END_BERSERK_NEARBY_SPRITES,		textGrid[# 1, SPAR_EFFECTS.END_BERSERK_NEARBY_SPRITES],			end_berserk_nearby_sprites,		EMPTY_SFX,			sparFX_clearStatus);			
master_grid_add_spar_effect(SPAR_EFFECTS.END_BERSERK_TEAM,					textGrid[# 1, SPAR_EFFECTS.END_BERSERK_TEAM],					end_berserk_team,				EMPTY_SFX,			sparFX_clearStatus);			
master_grid_add_spar_effect(SPAR_EFFECTS.END_BERSERK_GLOBAL,				textGrid[# 1, SPAR_EFFECTS.END_BERSERK_GLOBAL],					end_berserk_global,				EMPTY_SFX,			sparFX_clearStatus);			
master_grid_add_spar_effect(SPAR_EFFECTS.END_INVULNERABLE,					textGrid[# 1, SPAR_EFFECTS.END_INVULNERABLE],					end_invulnerable,				EMPTY_SFX,			sparFX_clearStatus);			
master_grid_add_spar_effect(SPAR_EFFECTS.END_INVULNERABLE_NEARBY_ALLIES,	textGrid[# 1, SPAR_EFFECTS.END_INVULNERABLE_NEARBY_ALLIES],		end_invulnerable_nearby_allies,	EMPTY_SFX,			sparFX_clearStatus);			
master_grid_add_spar_effect(SPAR_EFFECTS.END_INVULNERABLE_NEARBY_ENEMIES,	textGrid[# 1, SPAR_EFFECTS.END_INVULNERABLE_NEARBY_ENEMIES],	end_invulnerable_nearby_enemies,EMPTY_SFX,			sparFX_clearStatus);			
master_grid_add_spar_effect(SPAR_EFFECTS.END_INVULNERABLE_NEARBY_SPRITES,	textGrid[# 1, SPAR_EFFECTS.END_INVULNERABLE_NEARBY_SPRITES],	end_invulnerable_nearby_sprites,EMPTY_SFX,			sparFX_clearStatus);			
master_grid_add_spar_effect(SPAR_EFFECTS.END_INVULNERABLE_TEAM,				textGrid[# 1, SPAR_EFFECTS.END_INVULNERABLE_TEAM],				end_invulnerable_team,			EMPTY_SFX,			sparFX_clearStatus);			
master_grid_add_spar_effect(SPAR_EFFECTS.END_INVULNERABLE_GLOBAL,			textGrid[# 1, SPAR_EFFECTS.END_INVULNERABLE_GLOBAL],			end_invulnerable_global,		EMPTY_SFX,			sparFX_clearStatus);			
master_grid_add_spar_effect(SPAR_EFFECTS.RESTORE_ALIGNMENT,					textGrid[# 1, SPAR_EFFECTS.RESTORE_ALIGNMENT],					restore_alignment,				EMPTY_SFX,			sparFX_clearStatus);			
master_grid_add_spar_effect(SPAR_EFFECTS.RESTORE_SIZE,						textGrid[# 1, SPAR_EFFECTS.RESTORE_SIZE],						restore_size,					EMPTY_SFX,			sparFX_clearStatus);			
master_grid_add_spar_effect(SPAR_EFFECTS.SKYDIVE_APPLY_DAMAGE,				textGrid[# 1, SPAR_EFFECTS.SKYDIVE_APPLY_DAMAGE],				skydive_apply_damage,			EMPTY_SFX,			spr_spellFX_basicAttack);				
master_grid_add_spar_effect(SPAR_EFFECTS.SNEAK_ATTACK_APPLY_DAMAGE,			textGrid[# 1, SPAR_EFFECTS.SNEAK_ATTACK_APPLY_DAMAGE],			sneak_attack_apply_damage,		EMPTY_SFX,			spr_spellFX_basicAttack);				
master_grid_add_spar_effect(SPAR_EFFECTS.SKYDIVE_FAILURE,					textGrid[# 1, SPAR_EFFECTS.SKYDIVE_FAILURE],					skydive_failure,				EMPTY_SFX,			sparFX_failure);				
master_grid_add_spar_effect(SPAR_EFFECTS.SNEAK_ATTACK_FAILURE,				textGrid[# 1, SPAR_EFFECTS.SNEAK_ATTACK_FAILURE],				sneak_attack_failure,			EMPTY_SFX,			sparFX_failure);				
master_grid_add_spar_effect(SPAR_EFFECTS.ACTIVATE_ABILITY,					textGrid[# 1, SPAR_EFFECTS.ACTIVATE_ABILITY],					activate_ability,				EMPTY_SFX,			EMPTY_SPRITE);		
master_grid_add_spar_effect(SPAR_EFFECTS.BONUS_SPELL,						textGrid[# 1, SPAR_EFFECTS.BONUS_SPELL],						bonus_spell,					EMPTY_SFX,			EMPTY_SPRITE);
master_grid_add_spar_effect(SPAR_EFFECTS.IMPROVE_RANGE,						textGrid[# 1, SPAR_EFFECTS.IMPROVE_RANGE],						improve_range_spar_effect,		EMPTY_SFX,			EMPTY_SPRITE);
master_grid_add_spar_effect(SPAR_EFFECTS.SYNCHRONIZE_SPRITES,				textGrid[# 1, SPAR_EFFECTS.SYNCHRONIZE_SPRITES],				synchronize_sprites,			EMPTY_SFX,			EMPTY_SPRITE);
master_grid_add_spar_effect(SPAR_EFFECTS.ARBITRATE_TURN,					textGrid[# 1, SPAR_EFFECTS.ARBITRATE_TURN],						arbitrate_turn,					EMPTY_SFX,			EMPTY_SPRITE);
master_grid_add_spar_effect(SPAR_EFFECTS.BASIC_ATTACK_FIRE,					textGrid[# 1, SPAR_EFFECTS.BASIC_ATTACK_FIRE],					basic_attack_fire,				EMPTY_SFX,			EMPTY_SPRITE);
master_grid_add_spar_effect(SPAR_EFFECTS.BASIC_ATTACK_WATER,				textGrid[# 1, SPAR_EFFECTS.BASIC_ATTACK_WATER],					basic_attack_water,				EMPTY_SFX,			EMPTY_SPRITE);
master_grid_add_spar_effect(SPAR_EFFECTS.BASIC_ATTACK_STORM,				textGrid[# 1, SPAR_EFFECTS.BASIC_ATTACK_STORM],					basic_attack_storm,				EMPTY_SFX,			EMPTY_SPRITE);
master_grid_add_spar_effect(SPAR_EFFECTS.BASIC_ATTACK_EARTH,				textGrid[# 1, SPAR_EFFECTS.BASIC_ATTACK_EARTH],					basic_attack_earth,				EMPTY_SFX,			EMPTY_SPRITE);
master_grid_add_spar_effect(SPAR_EFFECTS.BASIC_ATTACK_RESISTANCE,			textGrid[# 1, SPAR_EFFECTS.BASIC_ATTACK_RESISTANCE],			basic_attack_resistance,		EMPTY_SFX,			EMPTY_SPRITE);
master_grid_add_spar_effect(SPAR_EFFECTS.BASIC_ATTACK_AGILITY,				textGrid[# 1, SPAR_EFFECTS.BASIC_ATTACK_AGILITY],				basic_attack_agility,			EMPTY_SFX,			EMPTY_SPRITE);
master_grid_add_spar_effect(SPAR_EFFECTS.SET_IMMOBILIZED,					textGrid[# 1, SPAR_EFFECTS.SET_IMMOBILIZED],					set_immobilized,				EMPTY_SFX,			EMPTY_SPRITE);
master_grid_add_spar_effect(SPAR_EFFECTS.REMOVE_IMMOBILIZED,				textGrid[# 1, SPAR_EFFECTS.REMOVE_IMMOBILIZED],					remove_immobilized,				EMPTY_SFX,			EMPTY_SPRITE);
master_grid_add_spar_effect(SPAR_EFFECTS.NEGATE_DAMAGE,						textGrid[# 1, SPAR_EFFECTS.NEGATE_DAMAGE],						negate_damage,					EMPTY_SFX,			EMPTY_SPRITE);
master_grid_add_spar_effect(SPAR_EFFECTS.NEGATE_SPELL_COST,					textGrid[# 1, SPAR_EFFECTS.NEGATE_SPELL_COST],					negate_spell_cost,				EMPTY_SFX,			EMPTY_SPRITE);
master_grid_add_spar_effect(SPAR_EFFECTS.FORCE_SPELL_FAILURE,				textGrid[# 1, SPAR_EFFECTS.FORCE_SPELL_FAILURE],				force_spell_failure,			EMPTY_SFX,			EMPTY_SPRITE);
master_grid_add_spar_effect(SPAR_EFFECTS.OUT_OF_RANGE_SELECTION,			textGrid[# 1, SPAR_EFFECTS.OUT_OF_RANGE_SELECTION],				out_of_range_selection,			EMPTY_SFX,			EMPTY_SPRITE);
master_grid_add_spar_effect(SPAR_EFFECTS.OUT_OF_RANGE_ACTION,				textGrid[# 1, SPAR_EFFECTS.OUT_OF_RANGE_ACTION],				out_of_range_action,			EMPTY_SFX,			EMPTY_SPRITE);
#endregion
