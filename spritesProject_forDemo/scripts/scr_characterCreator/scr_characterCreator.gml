...
function character_creator_draw_player(_eyewear, _skintone, _outfit, _outfitColor, _hair, _hairColor, _hat, _hatColor, _shoes, _shoeColor, _accessory) {
	...
	draw_sprite_part_ext(eyewearSheet,	0, (playerFacing * (humanSpriteWidth * 4)),		humanSheetHeight * _eyewear,	humanSpriteWidth, humanSpriteHeight, playerDisplayX, playerDisplayY, 1, 1, c_white,			1.0);
	...
	draw_sprite_part_ext(accessorySheet,0, (playerFacing * (humanSpriteWidth * 4)),		humanSheetHeight * _accessory,	humanSpriteWidth, humanSpriteHeight, playerDisplayX, playerDisplayY, 1, 1, c_white,			1.0);
}
